(() => {
  ...
  const boot=()=>{initHomeInventory();if(!document.getElementById('home-inventory-list')?.children.length)setTimeout(initHomeInventory,250);setTimeout(initHomeInventory,900);};
